...
public class ListaSerieAssistindoAdapter extends RecyclerView.Adapter<ListaSerieAssistindoAdapter.ListaSerieViewHolder> {
    private List<Serie> series;
    private Context context;

    public ListaSerieAssistindoAdapter(List<Serie> series, Context context) {
        this.series = series;
    ...
    public void onBindViewHolder(ListaSerieViewHolder holder, int position) {
        ...
        holder.textViewQuantidadeTemporada.setText(serie.getTemporadas().size() + " temporadas");

        int quantidadeCapitulos = 0;
        for (Temporada temporada : serie.getTemporadas())
            quantidadeCapitulos += temporada.getCapitulos();

        holder.textViewQuantidadeCapitulos.setText(quantidadeCapitulos + " capítulos");
    }
    ...
    public class ListaSerieViewHolder extends RecyclerView.ViewHolder {
        ...
        private void showPopup(View view, final Serie serie) {
            ...
            inflate.inflate(R.menu.opcoes_serie_assistindo, popup.getMenu());
            ...
            popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    switch (item.getItemId()) {
                        case R.id.assistirDepois:
                            assistirDepois(serie);
                            break;
                        case R.id.excluir:
                            excluir(serie);
                            break;
        ...
        private void assistirDepois(Serie serie) {
            ...
            ListaSeriesPrevista listaAmigoFragment = (ListaSeriesPrevista) ListaSeriesPrevista.getInstance();
