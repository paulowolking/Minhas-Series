...
import com.paulo.minhas_series.ui.actitivitys.adapters.ListaSeriePrevistaAdapter;
 ...
 */
public class ListaSeriesPrevista extends BaseFragment {
    private static final String TAG = ListaSeriesAssistindo.class.getSimpleName();

    private static Fragment fragmentInstance;
    public EmptyRecyclerView recyclerView;
    private ListaSeriePrevistaAdapter adapter;
    private List<Serie> series = new ArrayList<>();
    private MinhasSeries minhasSeries;

    public static Fragment newInstance(Bundle args) {
        fragmentInstance = new ListaSeriesPrevista();
        args.putInt(SectionsPagerAdapter.FRAGMENT_TITLE_RESOURCE_ID, R.string.series_previstas);
    ...
    public void setupViews(View rootView) {
        ...
        adapter = new ListaSeriePrevistaAdapter(series, getContext());
